...
INSERT INTO public.parcel (id, isdatemoved, expectedcourierarrivaldate, ispaid, parcelfee, pin, priority, istoreturn, deliveryaddressid, parceltypeid, receivercontactdataid, clientid, senderaddressid) VALUES (7, false, '2020-01-02', false, 1.00, '2302', false, false, 8, 1, 4, 3, 9);
INSERT INTO public.parcel (id, isdatemoved, expectedcourierarrivaldate, ispaid, parcelfee, pin, priority, istoreturn, deliveryaddressid, parceltypeid, receivercontactdataid, clientid, senderaddressid) VALUES (8, false, '2019-12-27', true, 1.00, '3724', false, false, 8, 1, 4, 3, 9);
